...
function ajustar(){ 
  ...
  var vpreg= document.getElementById("pregunta"); 
   ...
   var superin= document.getElementsByClassName("super");
   var subinid= document.getElementsByClassName("subindice");

   for(var mm=0; mm<subinid.length; mm++){
     subinid[mm].style.fontSize=""+tamanio*0.8+"px";
   }

   for(var m=0; m<superin.length; m++){
        superin[m].style.fontSize=""+tamanio*0.8+"px";
   }
...
document.getElementById("panelBien").style.top=parseInt(vopciones[0].style.top)-5+"%"; 
