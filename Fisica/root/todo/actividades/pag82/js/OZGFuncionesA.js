 ...
 var alto=$(window).height();
  var ancho=$(window).width();
   var tamanio= ancho/45;  
    ...
    var vsuperindice=document.getElementsByClassName("superindice");
    
    $("#pregunta2").css("fontSize",""+tamanio*0.8+"pt");
    $("#pregunta3").css("fontSize",""+tamanio*0.8+"pt");

    $("#datos").css("fontSize",""+tamanio*0.8+"pt");

  for(var iii=0; iii<vsuperindice.length; iii++){
     vsuperindice[iii].style.fontSize=""+tamanio*0.5+"pt";
  }
