 ...
 function inciarEventos(ar){
  ...
  var vtexto=document.getElementsByClassName("texto");
   var vsubindice= document.getElementsByClassName("subindice");
  ...
  for(var ii=0; ii< vsubindice.length; ii++){
     vsubindice[ii].style.fontSize=""+tamanio*0.5+"pt";
  }
