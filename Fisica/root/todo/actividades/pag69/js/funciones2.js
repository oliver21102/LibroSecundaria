 ...
 var superin=document.getElementsByClassName("superindice");

 for(var ss=0; ss<superin.length; ss++){

   superin[ss].style.fontSize=""+tamanio*0.8+"pt";
 }
  /////////////////////
...
function pasarSiguiente(){
 setTimeout(function (){  
  ...
  //window.location="tres.html"; },2000);
}
