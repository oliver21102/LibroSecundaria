...
vpanelBien.style.top=parseInt(vopciones[0].style.top)-6+"%"; 
...
function ajustar(){ 
  ...
  $(".subindice").css("fontSize",""+tamanio*0.8+"px")
  $(".superindice").css("fontSize",""+tamanio*0.8+"px")
  ...
  var vpreg= document.getElementById("pregunta"); 
   ...
   $("#pregunta2").css("fontSize",""+tamanio+"pt");
   $("#pregunta3").css("fontSize",""+tamanio+"pt");
...
document.getElementById("panelBien").style.top=parseInt(vopciones[0].style.top)+"%"; 
}
...
function reubicar(obj){
  ...
  vpanelMal.style.top=parseInt(posTop)-7+"%";
}
